...
/**
 * Write a description of class SortGroupNameAction here.
 *
 * @author (your name)
 * @version (a version number or a date)
 */
public class SortGroupNameAction implements IGroupAction
{
    ...
    public LinkedHashMap<Integer, Models.GroupModel> sortMapByGroupName(LinkedHashMap<Integer, Models.GroupModel> filteredGroups){
        ...
        Collections.sort(list,new Comparator<Map.Entry<Integer,Models.GroupModel> >() {
            ...
            {
                String myStr1=entry1.getValue().getGroupName();
                String myStr2=entry2.getValue().getGroupName();
