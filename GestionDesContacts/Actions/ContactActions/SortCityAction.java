...
/**
 * Write a description of class SortCityAction here.
 *
 * @author (your name)
 * @version (a version number or a date)
 */
public class SortCityAction implements IContactAction
{    
    public void actionPerformed(ActionEvent e){
        Views.ContactsView view = Controllers.ContactsController.getInstance().getView();
        LinkedHashMap<Integer, Models.ContactModel> newMap = sortMapByCity(view.getFilteredContactsMap());
        
        view.setDataInList(newMap);
    }
    
    public LinkedHashMap<Integer, Models.ContactModel> sortMapByCity(LinkedHashMap<Integer,Models.ContactModel> filteredContacts){
        ...
        Collections.sort(list,new Comparator<Map.Entry<Integer,Models.ContactModel> >() {
            ...
            {
                String myStr1=entry1.getValue().getCity();
                String myStr2=entry2.getValue().getCity();
